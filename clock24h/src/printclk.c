...
void print_separator_at(Font font, int row, int col);
...
void print_clock_at(Font font, int row, int hour, int minute, int second)
{
    ...
    // Separators
    print_separator_at(font, row, 26);
    print_separator_at(font, row, 50);
}
