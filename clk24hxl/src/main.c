/*
    ...
    PROJECT: 24 HOURS CLOCK WITH EXTRA LARGE FONT
    PROGRAMMER: FARHAN ALI QURESHI
    DESCRIPTION: 24 hours clock, formatted as HH:MM with blinking
    separator, and extra large font using extended ASCII characters.
